...
function(qt_internal_find_apple_system_framework out_var framework_name)
    ...
    if(${cache_var_name} AND ${cache_var_name} MATCHES ".framework$")
        # Frameworks unavailable on macOS 10.9 must be weak-linked
        set(_weak_frameworks Metal MetalKit UniformTypeIdentifiers)
        list(FIND _weak_frameworks "${framework_name}" _is_weak)
        if(NOT _is_weak EQUAL -1 AND CMAKE_OSX_DEPLOYMENT_TARGET VERSION_LESS "10.11")
